...
## [Unity CRT](./Sections/UnityCRT.md)
...
## [Easing Functions](./_InternalAssets/shader_functions/easings.hlsl)

Although there isn't a section on this one (yet), I spent roughly a week reinterpreting and fixing the [easings.net](easings.net) functions to work well in graphics.

# Amplify Developer?

Oh cool! I got you covered in a different project as well!

Go check out [Amplify-Magic](https://github.com/OwenTheProgrammer/Amplify-Magic)